...
async function initDb() {
    ...
    const tables = [
        ...
        `CREATE TABLE IF NOT EXISTS submissions (
            ...
            ai_analysis_state TEXT DEFAULT 'pending',
            ai_analyzed_at TEXT DEFAULT NULL,
            ai_reused_from_submission_id INTEGER DEFAULT NULL,
    ...
    const migrations = [
        ...
        'CREATE INDEX IF NOT EXISTS idx_submissions_assignment_student_time ON submissions (assignment_id, student_id, submitted_at)',
        'CREATE INDEX IF NOT EXISTS idx_submissions_content_hash ON submissions (assignment_id, student_id, content_hash)',

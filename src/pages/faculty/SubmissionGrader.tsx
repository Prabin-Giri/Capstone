...
const SubmissionGrader: React.FC = () => {
    ...
    const [leftWidth, setLeftWidth] = useState(() => {
        ...
        return saved ? Math.max(LEFT_MIN, parseInt(saved)) : LEFT_MIN;
    });
    ...
    useEffect(() => {
        const onMove = (e: MouseEvent) => {
            ...
            setLeftWidth(Math.max(LEFT_MIN, Math.min(e.clientX - left, 360)));
        };
        const onUp = () => {
    ...
    const showDrawerBackdrop = isMobileViewport && (leftDrawerOpen || rightDrawerOpen);
    ...
    const handleStudentsButton = () => {
        ...
        if (isLeftSidebarCollapsed) {
            setLeftWidth(prev => Math.max(prev, LEFT_MIN));
        }
                ...
                <div className="grading-sidebar-content">
                        ...
                        <div className="grading-form">
                            ...
                            <div className="form-actions single">
                                <Button onClick={handleSave}>Submit Final Grade</Button>
                            </div>
                        </div>
                </div>
            </div>

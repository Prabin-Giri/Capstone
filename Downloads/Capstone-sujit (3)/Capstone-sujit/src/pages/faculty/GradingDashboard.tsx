...
import { getAssignment, getSubmissions, getFileUrl, formatGrade } from '../../lib/api';
        ...
        <div className="grading-dashboard-container">
            <div className="dashboard-header">
                <div>
                    ...
                    <p className="dashboard-subtitle" style={{ margin: '0.25rem 0 0', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                        Grade submissions and use assignment rubrics when available (instructors & TAs).
                    </p>
                </div>
                                ...
                                return (
                                    <tr key={latestSubmission.student_id}>
                                        ...
                                        <td className="text-medium">
                                            {latestSubmission.grade !== undefined && latestSubmission.grade !== null ? formatGrade(latestSubmission.grade) : '-'}
                                        </td>
                                        <td>
                                            <Button
                                                size="sm"

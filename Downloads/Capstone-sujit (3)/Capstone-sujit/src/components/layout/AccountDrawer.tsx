...
import { API_BASE, UPLOADS_BASE, safeFetch } from '../../lib/api';
    ...
    const handleSaveInfo = async () => {
        ...
        try {
            ...
            if (editingFields.avatar && pendingAvatar) {
                ...
                const uploadResponse = await safeFetch(`${API_BASE}/uploads/profile-picture/${userData.id}`, {
                    method: 'POST',
                    body: formData
                });
            ...
            if (editingFields.name || editingFields.email) {
                ...
                const response = await safeFetch(`${API_BASE}/users/profile`, {
                    method: 'PUT',
            ...
            <div className="profile-hero">
                <div className="profile-avatar-large">
                    {pendingAvatar ? (
                        ...
                        <img src={`${UPLOADS_BASE}/uploads/${userData.profilePicture}`} alt="Profile" className="avatar-img" />
                    ) : (
